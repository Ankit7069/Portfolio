...
const Hero = () => {
  return (
    <section id="about" className="relative z-10 min-h-screen flex items-center justify-center pt-20 px-4">
      <div className="absolute inset-0 bg-linear-to-b from-transparent via-slate-900/50 to-slate-900 pointer-events-none"></div>
      <div className="max-w-7xl mx-auto text-center">
        ...
        <Reveal delay={100}>
          <h1 className="text-5xl md:text-8xl font-bold text-white mb-6 leading-tight drop-shadow-[0_0_25px_rgba(139,92,246,0.3)]">
            Hi, I'm Kaizen. <br/>
            <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-400 via-violet-500 to-fuchsia-500 animate-gradient-x bg-size-[200%_auto]">
              Sculpting Sound
            </span>
          </h1>
        </Reveal>
        ...
        <Reveal delay={300}>
          <div className="flex flex-col sm:flex-row justify-center gap-4 px-8">
            <a href="#work" className="group relative px-8 py-4 bg-white text-slate-900 font-bold rounded-full overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-lg shadow-white/10">
              ...
              <div className="absolute inset-0 bg-linear-to-r from-cyan-400 to-violet-500 opacity-0 group-hover:opacity-100 transition-opacity"></div>
            </a>
